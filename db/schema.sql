...
CREATE TABLE `book` (
  ...
  CONSTRAINT `fk_book_genre_name` FOREIGN KEY (`genre_name`) REFERENCES `genre` (`genre_name`) ON DELETE RESTRICT
...
CREATE TABLE `post` (
  ...
  CONSTRAINT `fk_post_thread_id` FOREIGN KEY (`thread_id`) REFERENCES `thread` (`thread_id`) ON DELETE CASCADE,
...
CREATE TABLE `thread` (
  ...
  CONSTRAINT `fk_thread_community_name` FOREIGN KEY (`community_name`) REFERENCES `community` (`community_name`) ON DELETE RESTRICT,
  CONSTRAINT `fk_thread_username` FOREIGN KEY (`username`) REFERENCES `user` (`username`) ON DELETE RESTRICT
...
-- Dump completed on 2026-05-02 13:43:44
